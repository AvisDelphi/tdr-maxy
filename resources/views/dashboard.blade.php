    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-white shadow-lg flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-3">
                ...
                <a href="{{ url('/affiliation') }}" class="flex items-center space-x-2 font-semibold text-gray-600 hover:text-red-600">
                    <img src="https://img.icons8.com/?size=100&id=7867&format=png&color=000000"
                ...
                <a href="{{ url('/chatbotdashboard') }}" class="flex items-center space-x-2 font-semibold text-gray-600 hover:text-red-600">
                    <img src="https://img.icons8.com/?size=100&id=100414&format=png&color=000000"
                        alt="Missions Icon" class="w-5 h-5">
                    <span>Chatbot</span>
                </a>
