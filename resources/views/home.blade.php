        ...
        <section class="py-16 px-6 md:px-20 bg-zinc-900 text-white">
            ...
            <div class="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-4">
                        <img src="https://via.placeholder.com/40x40.png?text=👍" alt="Reliability Icon"
                            class="w-10 h-10 bg-red-600 rounded-full p-2">
                        <div>
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        <img src="https://via.placeholder.com/40x40.png?text=⚡" alt="Fast Icon"
                            class="w-10 h-10 bg-red-600 rounded-full p-2">
                        <div>
                    ...
                    <div class="flex items-start gap-4">
                        <img src="https://via.placeholder.com/40x40.png?text=✨" alt="Style Icon"
                            class="w-10 h-10 bg-red-600 rounded-full p-2">
                        <div>
                    ...
                    <div class="flex items-start gap-4">
                        <img src="https://via.placeholder.com/40x40.png?text=🌱" alt="Green Icon"
                            class="w-10 h-10 bg-red-600 rounded-full p-2">
                        <div>
        ...
        <div class="flex flex-col items-start md:items-end space-y-3">
            ...
            <div class="flex gap-4">
                <a href="https://instagram.com" target="_blank" class="hover:text-red-500 transition">
                    <img src="https://img.icons8.com/?size=100&id=32323&format=png&color=000000" alt="Instagram" class="w-6 h-6">
                </a>
                <a href="https://tiktok.com" target="_blank" class="hover:text-red-500 transition">
                    <img src="https://img.icons8.com/?size=100&id=118640&format=png&color=000000" alt="TikTok" class="w-6 h-6">
                </a>
            </div>
        </div>
    </div>
